...
import { FolderOpen, Plus, Pencil, Trash2, Image, FileText, Book } from "lucide-react";
  ...
  return (
    <DashboardLayout>
      <PageHeader
        ...
        description="View and manage portfolios for this student"
        breadcrumbs={[
          { label: "Dashboard", href: "/dashboard" },
          { label: "Classes", href: "/classes" },
          { label: "Students", href: "/classes" },
          { label: "Portfolios" },
        ]}
        action={
          <Link href={`/portfolios/new?profileId=${profileId}`}>
            <Button>
            ...
            <Card key={portfolio.id} className="overflow-hidden">
              ...
              <CardContent className="p-4">
                ...
                <div className="mt-4 flex gap-2">
                  <Link
                    href={`/portfolios/${portfolio.id}/edit?profileId=${profileId}`}
                    className="flex-1"
                  >
